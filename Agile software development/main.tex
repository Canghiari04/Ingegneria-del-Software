...
\subsection*{INVEST}
\large
\textit{User stories} rappresenta uno degli \textit{agile software development} di maggiore uso, dove ad un primo impatto potrebbe essere di facile uso e implementazione; tuttavia, la propria complessità comincia ad emergere di pari passo all'aumento della struttura del sistema software. Per questa difficoltà crescente si adottano strumenti per comprendere la qualità e l'efficacia delle \textit{user stories}. I criteri sono riassunti come:
\begin{itemize}[label={-}]
    \itemsep0em
